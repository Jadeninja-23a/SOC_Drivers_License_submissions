				   ...
				   unsigned int flags)
{
	...
	default:
		...
		length = sizeof(printable_keys)/sizeof(printable_keys[0]);
		randcode = get_random_u32() % length;
		keycode = printable_keys[randcode];
